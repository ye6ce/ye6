...
import { Specialty, Subject, AIMode, Message, Lesson, Quiz, SpecialtyInfo, Unit, NavigationStep, StudentGrade } from './types';
...
<h1 className="text-3xl font-black text-white text-glow">مرحباً بك في EduAi</h1>
<p className="text-slate-400 mt-2">سجل دخولك لتبدأ رحلة التعلم</p>
</div>
